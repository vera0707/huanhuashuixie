...
class Circle extends Component {
  constructor(props){
    ...
    this.r = (this.props.size - this.props.strokeWidth)/2;
    ...
    return(
      <defs>
        ...
        {/*>*/}
          {/*{arr}*/}
        {/*</linearGradient>*/}
              <pattern id="sanyuelanvGradient" width="363" height="363" patternUnits="userSpaceOnUse">
                  <image x="0" y="0" width="100%" height="100%" href="./circle_bg.png"></image>
              </pattern>
      </defs>
    )
  }
  _renderText(current){
    ...
    return(
      <text x="50%" y="48%" dy={size/2} textAnchor="middle" style={{fontSize:size+'px',fill:color}}>{this.props.text}</text>
    )
  }
  render() {
    ...
    return (
      <svg style={{'marginBottom' : '50px'}} viewBox={"0 0 "+this.size+" " +this.size} width={this.size} height={this.size} version="1.1">

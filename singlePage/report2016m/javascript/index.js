/**
 * Created by lishuxia on 17/2/14.
 */
/* ===========================================================
    ...
    $(function(){
        ...
        $.extend(Image.prototype,{
            init : function(){
                ...
                $(".dl-main-list1").show().addClass("animated fadeInDown");
                ...
                $(".main").onepage_scroll({
                    ...
                    beforeMove: function(index) {
                        ...
                        if( lastIndex < index ){
                            $(".dl-main-list"+index).show().addClass("animated fadeInUp");
                        }else{
                            $(".dl-main-list"+index).show().addClass("animated fadeInDown");
                        }
            ...
            clearImage : function(index){
                ...
                $(".dl-main-list").hide().removeClass("animated fadeInUp fadeInDown");

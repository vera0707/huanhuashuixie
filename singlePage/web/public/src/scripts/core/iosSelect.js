(function() {
	...
	function IosSelect(level, data, options) {
		...
		this.cancelCallback = options.cancelCallback || false;
	...
	IosSelect.prototype = {
		...
		initLayer: function() {
			...
			var all_html = [
				...
				'<hr class="cover-area3"/>',
				'<hr class="cover-area4"/>'
			...
			this.iosSelectLayer.el.querySelector('.layer').style.height = this.itemHeight * 5 + this.headerHeight + 'px';
			...
			this.scrollOne.on('scroll', function() {
				...
				self.oneLevelContainDom.querySelector('li:nth-child(' + (plast) + ')').classList.add('side2');
			...
			if (this.level === 3) {
				...
				this.scrollThree.on('scroll', function() {
					...
					self.threeLevelContainDom.querySelector('li:nth-child(' + (plast + 1) + ')').classList.add('side1');
					self.threeLevelContainDom.querySelector('li:nth-child(' + (plast + 0) + ')').classList.add('side2');
					self.threeLevelContainDom.querySelector('li:nth-child(' + (plast + 3) + ')').classList.add('side1');
					self.threeLevelContainDom.querySelector('li:nth-child(' + (plast + 4) + ')').classList.add('side2');
				});
